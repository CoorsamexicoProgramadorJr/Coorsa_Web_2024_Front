<script setup></script>
<template>
  <section class="w-screen h-screen md:h-[92vh] text-white bg-[url('/img/fondo-aliados.jpg')]">
    <article class="flex flex-col items-center justify-around p-4 md:p-8 h-1/2 lg:flex-row">
    ...
    <article class="flex flex-col items-center justify-around p-4 md:p-8 lg:pl-9 lg:flex-row-reverse h-1/2">
      <h2 class="text-transparent text-4xl uppercase text-border lg:text-9xl lg:w-[45%]">Visión</h2>
      <p class="text-xl font-light lg:w-[50%] xl:w-[45%] lg:text-2xl xl:text-3xl text-center lg:text-left">
