...
<template>
  <section class="w-[100vw] min-h-[92vh] p-[3%]" id="sec-vacantes">
    ...
    <div class="flex lg:flex-row flex-col items-center justify-center w-full max-h-[40%] xl:gap-[10%] lg:gap-[5%] xl:text-4xl lg:text-3xl text-2xl lg:space-y-0 space-y-10 text-red-700">
      <button @click="openList(1)" class="xl:w-1/4 lg:w-[28%] w-[80%] lg:h-full h-16 lg:min-h-80 lg:rounded-2xl rounded-full font-semibold  pb-[1%] border-2 border-red-700 uppercase">
        Practicas
      </button>
      <button @click="openList(2)" class="xl:w-1/4 lg:w-[28%] w-[80%] lg:h-full h-16 lg:min-h-80 lg:rounded-2xl rounded-full font-semibold pb-[1%] border-2 border-red-700 uppercase">
        Operación
      </button>
      <button @click="openList(3)" class="xl:w-1/4 lg:w-[28%] w-[80%] lg:h-full h-16 lg:min-h-80 lg:rounded-2xl rounded-full font-semibold pb-[1%] border-2 border-red-700 uppercase lg:break-words lg:tracking-tight">
        Administrativas
      </button>
    </div>
            ...
            <div class=" my-[1%]">
              ...
              <dd class="mx-[2%]">
                <ul class="list-disc mx-[2%]">
                  <li v-for="requirement in vacancy.requirements" :key="requirement" class="font-light uppercase my-[1%] xl:leading-7 leading-5">
                    {{ requirement }}
                  </li>
                </ul>
              </dd>
