  ...
  <nav class="bg-red-700 w-screen h-[8vh] flex justify-between items-center fixed top-0 left-0 right-0 px-[3%]">
    ...
    <div class=" xl:w-[60%] lg:w-[70%] lg:h-[100%] gap-[2%] text-white uppercase tracking-wide xl:text-xl lg:text lg:flex sm:hidden">
      ...
      <div class="flex items-center justify-center flex-1 group sm:flex-col">
        ...
        <div class="lg:absolute lg:top-[8vh] xl:right-[2%] lg:right-0 bg-red-700 lg:h-[17vh] xl:w-[50vw] lg:w-[70vw] lg:border-t lg:border-t-white lg:divide-x divide-white sm:hidden group-hover:flex 2xl:text-xl xl:text-lg/3">
          <div class="lg:w-1/5 h-[100%] normal-case p-[1%] hover:bg-red-800">
            <a href="" class="h-[100%] flex flex-col xl:justify-around items-center">
              ...
              <span class="font-bold max-h-[33.33%]">Warehouse</span>
          ...
          <div class="lg:w-1/5 h-[100%] normal-case p-[1%] hover:bg-red-800">
            <a href="" class="h-[100%] flex flex-col justify-around items-center">
              ...
              <span class="text-xs leading-tight tracking-tighter text-center max-h-[33.33%]">
          ...
          <div class="lg:w-1/5 h-[100%] normal-case p-[1%] hover:bg-red-800">
            <a href="" class="h-[100%] flex flex-col justify-around items-center">
              ...
              <span class="text-xs leading-tight tracking-tighter text-center max-h-[33.33%]">Mano de obra cualificada.</span>
            </a>
          </div>
          <div class="lg:w-1/5 h-[100%] normal-case p-[1%] hover:bg-red-800">
            <a href="" class="h-[100%] flex flex-col xl:justify-around items-center">
          ...
          <div class="lg:w-1/5 h-[100%] normal-case p-[1%] hover:bg-red-800">
            <a href="" class="h-[100%] flex flex-col items-center lg:justify-around">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="max-h-[33.33%]">
