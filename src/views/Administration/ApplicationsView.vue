...
<template>
  <section class="h-screen pt-[8vh] p-3 lg:ml-[25%] lg:w-3/4 lg:pt-5">
    ...
    <div class="px-2 mt-5 overflow-auto lg:px-3 max-h-[80%]">
      <div v-for="application in appAdmStore.applications" :key="application.id" @click="appAdmStore.selectApplication(application); appAdmStore.manageApplicationDetails()" class="flex items-center justify-between text-gray-600 h-14 border-y hover:bg-gray-400 hover:text-white hover:cursor-pointer">
        <div>
