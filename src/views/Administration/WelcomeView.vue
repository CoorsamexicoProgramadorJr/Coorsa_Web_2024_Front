...
<template>
  <section class="h-screen pt-[8vh] p-4">
    ...
    <h3 class="mt-10 mb-2 text-lg font-semibold">Algunas de las cosas que puedes hacer:</h3>
    <article class="px-2 mb-5 space-y-3">
      <h4 class="mt-3 text-base">Vacantes y Tipos de Vacantes</h4>
      <div class="flex justify-around">
        <div class="flex items-center gap-0.5 text-blue-800">
        ...
        <div class="flex items-center gap-0.5 text-red-700">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <article class="px-2 space-y-2">
      <h4 class="text-base">Consultas y Aplicaciones</h4>
      <div class="flex justify-around">
