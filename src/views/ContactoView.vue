  ...
  <section class="flex w-screen h-screen text-white bg-black">
    ...
    <article class="w-2/3 h-full pt-[8vh] px-[10%]">
      ...
      <form action="" v-if="vacancyId.length == 0" class="h-[80%] pt-[5%] grid grid-cols-2 grid-rows-6 gap-x-[5%]">
        ...
        <div class="flex flex-col justify-center w-full gap-[8%]">
          <label for="service" class="text-xl font-semibold uppercase">Servicio</label>
          <select name="service" id="service" class="h-[40%] w-full rounded-xl outline-none border focus:border-2 border-red-700 px-[1%] text-black text-center uppercase">
        ...
        <div class="flex flex-col justify-center w-full gap-[8%]">
          <label for="state" class="text-xl font-semibold uppercase">Estado</label>
          <select name="state" id="state" class="h-[40%] w-full rounded-xl outline-none border focus:border-2 border-red-700 px-[1%] text-black text-center uppercase">
      ...
      <footer class="h-[20%] flex flex-col items-center">
        ...
        <p class="text-xl font-light uppercase h-1/3">Ellos confian en nosotros</p>
      </footer>
    </article>
  </section>
</template>