...
<template>
  <section class="flex w-screen h-screen text-white bg-black">
    <article class="w-1/3 h-full border-r-[4px] pt-[8vh] flex flex-col justify-center items-center">
      <h2 class="text-5xl font-light">Zona del Mapa</h2>
    </article>
    <article class="w-2/3 h-full pt-[8vh] px-[10%]">
      <!-- Contacto form -->
      <form action="" v-if="vacancyId.length == 0" class="h-[80%] pt-[5%] grid grid-cols-2 grid-rows-6 gap-x-[5%]">
        <div class="flex flex-col justify-center w-full gap-[8%] xl:text-xl lg:text-lg">
        ...
        <div class="flex flex-col justify-center w-full gap-[8%]">
          <label for="phone" class="font-semibold uppercase xl:text-xl lg:text-lg">Teléfono</label>
          <fieldset class="flex w-full h-[40%] text-black">
            <select name="lada" id="lada" class="w-[28%] border-l border-y focus:border-l-2 focus:border-y-2 border-red-700 rounded-l-xl px-[2%] outline-none  xl:text-sm lg:text-xs">
        ...
        <div class="flex flex-col col-span-2 justify-center w-full gap-[8%] xl:text-xl lg:text-lg">
        ...
        <div class="flex flex-col justify-center w-full gap-[8%]">
          <label for="service" class="font-semibold uppercase xl:text-xl lg:text-lg">Servicio</label>
          <select name="service" id="service" class="h-[40%] w-full rounded-xl outline-none border focus:border-2 border-red-700 px-[1%] text-black text-center uppercase lg:text-sm">
        ...
        <div class="flex flex-col justify-center w-full gap-[8%]">
          <label for="state" class="font-semibold uppercase xl:text-xl lg:text-lg">Estado</label>
          <select name="state" id="state" class="h-[40%] w-full rounded-xl outline-none border focus:border-2 border-red-700 px-[1%] text-black text-center uppercase lg:text-sm">
        ...
        <div class="flex flex-col col-span-2 row-span-2 justify-center w-full gap-[8%]">
          <label for="message" class="font-semibold uppercase xl:text-xl lg:text-lg">Mensaje</label>
      ...
      <footer class="h-[20%] flex flex-col items-center">
        ...
        <p class="font-light uppercase xl:text-xl lg:text-lg h-1/3">Ellos confian en nosotros</p>
      </footer>
    </article>
  </section>
</template>